...
void printRidesList()
{
    std::cout << "1. Astro Orbiter" << std::endl;
    std::cout << "2. Barn Stormer" << std::endl;
    std::cout << "3. Big Thunder Mountain Railroad" << std::endl;
    std::cout << "4. Buzz Lightyear's Space Ranger Spin" << std::endl;
    std::cout << "5. Carousel of Progress" << std::endl; 
    std::cout << "6. Country Bear Jamboree" << std::endl;
    std::cout << "7. Dumbo the Flying Elephant" << std::endl;
    std::cout << "8. Haunted Mansion" << std::endl;
    std::cout << "9. It's a Small World" << std::endl;
    std::cout << "10. Jungle Cruise" << std::endl;
    std::cout << "11. Mad Tea Party" << std::endl;
    std::cout << "12. The Magic Carpets of Aladdin" << std::endl;
    std::cout << "13. Mickey's Philhar Magic" << std::endl;
    std::cout << "14. Monsters, Inc. Laugh Floor" << std::endl;
    std::cout << "15. Peter Pan's Flight" << std::endl;
    std::cout << "16. Pirates of the Caribbean" << std::endl;
    std::cout << "17. Prince Charming Regal Carrousel" << std::endl;
    std::cout << "18. Seven Dwarfs Mine Train" << std::endl;
    std::cout << "19. Space Mountain" << std::endl;
    std::cout << "20. Splash Mountain" << std::endl;
    std::cout << "21. The Many Adventures of Winnie the Pooh" << std::endl;
    std::cout << "22. Tomorrowland Speedway" << std::endl;
    std::cout << "23. Tomorrowland Transit Authority PeopleMover" << std::endl;
    std::cout << "24. Under the Sea - Journey of The Little Mermaid" << std::endl << endl; 
}
